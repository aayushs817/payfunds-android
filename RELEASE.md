# PayFunds Wallet Release

This document describes the release process for `PayFunds` app.
...
* Compute the sha256 and md5 checksums of the apk file and attach them as separate files, named PayFunds-wallet-[version].apk.sha256 and PayFunds-wallet-[version].apk.md5 respectively, under the 'Assets' section.

### 10. Make sure PayFunds Wallet is 'Reproducible' in [WalletScrutiny](https://walletscrutiny.com/android/com.payfunds.wallet/)

* After apk is uploaded to Google Play make sure that new version of PayFunds Wallet is 'Reproducible' in WalletScrutiny.