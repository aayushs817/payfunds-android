...
import com.payfunds.wallet.core.tor.EntityStatus
import com.payfunds.wallet.core.tor.Tor
import com.payfunds.wallet.core.tor.torutils.ProcessUtils
...
class TorOperator(private val torSettings: Tor.Settings, private val listener: Listener) :
    com.payfunds.wallet.core.tor.torcore.TorControl.Listener {
    ...
    private var torControl: com.payfunds.wallet.core.tor.torcore.TorControl? = null
        ...
        try {
            ...
            if (success) {
                ...
                if (runTorShellCmd(resManager.fileTor, resManager.fileTorrcCustom)) {
                    ...
                    torControl = com.payfunds.wallet.core.tor.torcore.TorControl(
