package com.payfunds.wallet.core.tor.torcore

import android.text.TextUtils
import com.payfunds.wallet.core.tor.ConnectionStatus
import com.payfunds.wallet.core.tor.Tor
...
class TorControl(
    ...
    private val listener: com.payfunds.wallet.core.tor.torcore.TorControl.Listener,
    ...
    private var torEventHandler: com.payfunds.wallet.core.tor.torcore.TorControl.TorEventHandler? = null
            ...
            while (controlConn == null && attempt++ < maxTries) {
                ...
                try {
                    ...
                    if (controlPort != -1) {
                        ...
                        val torConnSocket = Socket(com.payfunds.wallet.core.tor.torcore.TorConstants.Companion.IP_LOCALHOST, controlPort)
    ...
    private fun configConnection(conn: TorControlConnection, torInfo: Tor.Info): Tor.Connection {
        ...
        try {
            val fileCookie = File(appCacheHome,
                com.payfunds.wallet.core.tor.torcore.TorConstants.Companion.TOR_CONTROL_COOKIE
            )
    ...
    private fun addEventHandler(conn: TorControlConnection, torEventHandler: com.payfunds.wallet.core.tor.torcore.TorControl.TorEventHandler) {
    ...
    inner class TorEventHandler(private var torControl: com.payfunds.wallet.core.tor.torcore.TorControl) : EventHandler {
