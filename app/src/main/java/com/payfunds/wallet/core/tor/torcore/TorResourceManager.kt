...
import com.payfunds.wallet.core.tor.torutils.FileUtils
import com.payfunds.wallet.core.tor.torutils.NativeLoader
import com.payfunds.wallet.core.tor.torutils.NetworkUtils
import java.io.*
...
class TorResourceManager(private val torSettings: Tor.Settings) {
    ...
    private fun updateTorrcCustomFile(): File? {
        ...
        extraLines.append("ControlPortWriteToFile ").append(fileTorControlPort.absolutePath)
            .append('\n')
        extraLines.append("ControlPort Auto").append('\n')
        extraLines.append("SOCKSPort ")
            .append(checkPortOrAuto(TorConstants.SOCKS_PROXY_PORT_DEFAULT)).append('\n')
        ...
        extraLines.append("HTTPTunnelPort ")
            .append(checkPortOrAuto(TorConstants.HTTP_PROXY_PORT_DEFAULT)).append('\n')
        extraLines.append("DNSPort ").append(checkPortOrAuto(TorConstants.TOR_DNS_PORT_DEFAULT))
            .append('\n')
