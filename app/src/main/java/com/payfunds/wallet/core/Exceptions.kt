...
class NoAuthTokenException(override val message: String = "Auth Token is not set or empty") :
    Exception()

class InvalidAuthTokenException(override val message: String = "Auth Token is expired or invalid") :
    Exception()
