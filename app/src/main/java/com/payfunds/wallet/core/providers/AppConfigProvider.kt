...
class AppConfigProvider(localStorage: ILocalStorage) {
    ...
    val appVersion by lazy { com.payfunds.wallet.BuildConfig.VERSION_NAME }
    val appBuild by lazy { com.payfunds.wallet.BuildConfig.VERSION_CODE }
    ...
    val appInstagramLink by lazy { Translator.getString(R.string.appInstagramLink) }
    ...
    val privacyPolicyLink by lazy { Translator.getString(R.string.privacyPolicyUrl) }
    val appXLink by lazy { Translator.getString(R.string.appXLink) }
    val appYoutubeLink by lazy { Translator.getString(R.string.appYoutubeLink) }
    ...
    val zendeskApplicationId by lazy {
        Translator.getString(R.string.zendeskApplicationId)
    }

    val zendeskClientId by lazy {
        Translator.getString(R.string.zendeskClientId)
    }

    val coinApiKey by lazy {
        Translator.getString(R.string.coinApiKey)
    }

    val rpcUrl by lazy {
        Translator.getString(R.string.rpcUrl)
    }

    val routerAddress by lazy {
        Translator.getString(R.string.routerAddress)
    }
