...
import com.payfunds.wallet.core.storage.EvmAddressLabelDao
import com.payfunds.wallet.core.storage.EvmMethodLabelDao
import com.payfunds.wallet.core.storage.SyncerStateDao
...
class EvmLabelManager(
    ...
    private suspend fun syncAddressLabels(timestamp: Long) {
        ...
        addressLabelDao.update(addressLabels.map {
            EvmAddressLabel(
    ...
    private suspend fun syncMethodLabels(timestamp: Long) {
        ...
        methodLabelDao.update(methodLabels.map {
            EvmMethodLabel(
