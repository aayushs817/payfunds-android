...
import com.payfunds.wallet.modules.send.evm.confirmation.SendEvmConfirmationFragment
...
fun SendEvmScreen(
    ...
    val viewModel =
        viewModel<SendEvmViewModel>(factory = SendEvmModule.Factory(wallet, predefinedAddress))
                        ...
                        viewModel.getSendData()?.let {
                            navController.slideFromRightForResult<SendEvmConfirmationFragment.Result>(
                                ...
                                SendEvmConfirmationFragment.Input(
                                    ...
                                    amount = viewModel.amountState.amount?.toPlainString().toString()
                                )
                            ) {
                                if (it.success) {
