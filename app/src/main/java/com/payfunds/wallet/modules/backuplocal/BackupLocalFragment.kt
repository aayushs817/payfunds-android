package com.payfunds.wallet.modules.backuplocal
...
import com.payfunds.wallet.modules.backuplocal.fullbackup.SelectBackupItemsScreen
import com.payfunds.wallet.modules.backuplocal.password.BackupType
import com.payfunds.wallet.modules.backuplocal.password.LocalBackupPasswordScreen
import com.payfunds.wallet.modules.backuplocal.terms.LocalBackupTermsScreen
        ...
        composable("select_backup_items") {
            SelectBackupItemsScreen(
                onNextClick = { accountIdsList ->
                    val accountIds =
                        if (accountIdsList.isNotEmpty()) "?accountIds=" + accountIdsList.joinToString(
                            separator = ","
                        ) else ""
