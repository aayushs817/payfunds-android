package com.payfunds.wallet.modules.coin.analytics
...
import com.payfunds.wallet.core.IAppNumberFormatter
import com.payfunds.wallet.core.ViewModelUiState
import com.payfunds.wallet.core.brandColor
...
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.ActionType
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticChart
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticInfo
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticsViewItem
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.BlockViewItem
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.IconTitle
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.OverallScoreValue
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Title
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.TitleWithInfo
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Value
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.ChartViewItem
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.FooterType.FooterItem
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.PreviewBlockViewItem
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.PreviewChartType
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.RankType
import com.payfunds.wallet.modules.coin.analytics.CoinAnalyticsModule.ScoreCategory
import com.payfunds.wallet.modules.coin.audits.CoinAuditsModule
import com.payfunds.wallet.modules.coin.detectors.IssueItemParcelable
import com.payfunds.wallet.modules.coin.detectors.IssueParcelable
import com.payfunds.wallet.modules.market.ImageSource
import com.payfunds.wallet.modules.metricchart.ProChartModule
import com.payfunds.wallet.ui.compose.TranslatableString
import com.payfunds.wallet.ui.compose.TranslatableString.ResString
...
class CoinAnalyticsViewModel(
                ...
                blockchain?.let {
                    ...
                    chartSlices.add(
                        StackBarSlice(
                            ...
                            color = blockchain.type.brandColor ?: Color(0xFFC95454)
                        )
                    )
                    footerItems.add(
                        FooterItem(
    ...
    private fun getChartViewItem(
        ...
        val points = values.map {
            io.payfunds.chartview.models.ChartPoint(it.value.toFloat(), it.timestamp)
        }
