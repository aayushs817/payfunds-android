...
import com.payfunds.wallet.modules.market.MarketModule.ListType
...
import com.payfunds.wallet.modules.market.overview.MarketOverviewModule.MarketMetrics
import com.payfunds.wallet.modules.market.overview.MarketOverviewModule.MarketMetricsPoint
import com.payfunds.wallet.modules.market.overview.MarketOverviewModule.TopNftCollectionsBoard
import com.payfunds.wallet.modules.market.overview.MarketOverviewModule.TopPlatformsBoard
import com.payfunds.wallet.modules.market.overview.MarketOverviewModule.TopSectorsBoard
import com.payfunds.wallet.modules.market.overview.TopSectorsRepository.Companion.getCategoryMarketData
import com.payfunds.wallet.modules.market.search.MarketSearchModule.DiscoveryItem.Category
import com.payfunds.wallet.modules.market.topnftcollections.TopNftCollectionsViewItemFactory
import com.payfunds.wallet.modules.market.topplatforms.TopPlatformItem
import com.payfunds.wallet.modules.market.topplatforms.TopPlatformViewItem
...
import com.payfunds.wallet.modules.nft.NftCollectionItem
import com.payfunds.wallet.modules.nft.nftCollectionItem
import com.payfunds.wallet.ui.compose.Select
import com.payfunds.wallet.ui.extensions.MetricData
...
class MarketOverviewViewModel(
    ...
    private fun getViewItem(
        ...
        val topPlatformItems = TopPlatformsRepository.getTopPlatformItems(
            marketOverview.topPlatforms,
        ...
        val nftCollectionItems = marketOverview.nftCollections.getOrElse(timePeriod) { listOf() }
            .map { it.nftCollectionItem }
...
//    }
    ...
    private fun getMarketMetrics(
        ...
        val totalMarketCapPoints =
            globalMarketPoints.map { MarketMetricsPoint(it.marketCap, it.timestamp) }
        val volume24Points =
            globalMarketPoints.map { MarketMetricsPoint(it.volume24h, it.timestamp) }
        val defiMarketCapPoints =
            globalMarketPoints.map { MarketMetricsPoint(it.defiMarketCap, it.timestamp) }
