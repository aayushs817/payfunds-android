...
import com.payfunds.wallet.modules.multiswap.providers.tron.trigger_constant_contract_response.Result
import com.payfunds.wallet.modules.multiswap.providers.tron.trigger_constant_contract_response.TriggerConstantContractResponse
import com.payfunds.wallet.modules.multiswap.providers.tron.trigger_constant_contract_response.Value
import com.payfunds.wallet.modules.multiswap.providers.tron.trigger_smart_contract_response.TriggerSmartContractResponse
...
class TronGridServiceNew(
    ...
    private val logger = Logger.getLogger("TronGridServiceNew")
    ...
    suspend fun triggerConstantContract(
        ...
        val response = service.triggerConstantContract(
        ...
        check(response.result.result) { "triggerConstantContract error: ${response.result}" }
    ...
    suspend fun triggerSmartContract(
        ...
        check(response.result.result) { "triggerSmartContract error: ${response.result}}" }
    ...
    private interface TronGridExtensionAPI {
        ...
        fun triggerConstantContract(
            @Body request: TriggerConstantContractRequest
        ): Single<TriggerConstantContractResponse>
...
data class Parameter(
    val value: com.payfunds.wallet.modules.multiswap.providers.tron.Value,
    val type_url: String
)
