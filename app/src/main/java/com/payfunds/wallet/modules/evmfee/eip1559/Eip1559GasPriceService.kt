...
import com.payfunds.wallet.modules.evmfee.Bound
import com.payfunds.wallet.modules.evmfee.FeeSettingsError
import com.payfunds.wallet.modules.evmfee.FeeSettingsWarning
...
class Eip1559GasPriceService(
    ...
    private suspend fun syncRecommended() {
        try {
            val feeHistory = gasProvider.feeHistorySingle(
                blocksCount,
