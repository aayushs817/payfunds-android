...
import com.payfunds.wallet.modules.contacts.ContactsModule.ContactValidationException
...
class ContactsRepository(
    ...
    private val file: File
        get() = File(App.instance.filesDir, "PF_Contacts.json")
        ...
        return contactsJson.map { contactJson ->
            Contact(
                ...
                addresses = contactJson.addresses.mapNotNull { addressJson ->
                    marketKit.blockchain(addressJson.blockchain_uid)
