package com.payfunds.wallet.modules.evmfee.eip1559
...
import com.payfunds.wallet.core.feePriceScale
import com.payfunds.wallet.core.providers.Translator
import com.payfunds.wallet.entities.DataState
import com.payfunds.wallet.entities.FeePriceScale
import com.payfunds.wallet.entities.ViewState
import com.payfunds.wallet.modules.evmfee.FeeSummaryViewItem
import com.payfunds.wallet.modules.evmfee.FeeViewItem
import com.payfunds.wallet.modules.evmfee.GasPriceInfo
import com.payfunds.wallet.modules.evmfee.IEvmFeeService
import com.payfunds.wallet.modules.evmfee.Transaction
import com.payfunds.wallet.modules.fee.FeeItem
    ...
    private fun syncFeeViewItems(transactionStatus: DataState<Transaction>) {
        ...
        when (transactionStatus) {
            ...
            is DataState.Success -> {
                ...
                val viewState = transaction.errors.firstOrNull()?.let { ViewState.Error(it) }
                    ?: ViewState.Success
                ...
                val gasLimit = App.numberFormatter.format(
                    transactionStatus.data.gasData.gasLimit.toBigDecimal(),
                    0,
                    0
                )
