...
import com.payfunds.wallet.core.convertedError
import com.payfunds.wallet.modules.multiswap.EvmBlockchainHelper
import com.payfunds.wallet.modules.multiswap.ISwapFinalQuote
import com.payfunds.wallet.modules.multiswap.ISwapQuote
import com.payfunds.wallet.modules.multiswap.SwapFinalQuoteEvm
import com.payfunds.wallet.modules.multiswap.SwapQuoteOneInch
...
import com.payfunds.wallet.modules.multiswap.settings.SwapSettingRecipient
import com.payfunds.wallet.modules.multiswap.settings.SwapSettingSlippage
import com.payfunds.wallet.modules.multiswap.ui.DataFieldAllowance
import com.payfunds.wallet.modules.multiswap.ui.DataFieldRecipient
import com.payfunds.wallet.modules.multiswap.ui.DataFieldRecipientExtended
import com.payfunds.wallet.modules.multiswap.ui.DataFieldSlippage
import io.payfunds.core.scaleUp
...
object OneInchProvider : EvmSwapProvider() {
    ...
    override suspend fun fetchQuote(
        ...
        val amountOut = quote.toTokenAmount.toBigDecimal().movePointLeft(quote.toToken.decimals)
            .stripTrailingZeros()
    ...
    override suspend fun fetchFinalQuote(
        ...
        val amountOut = swap.toTokenAmount.toBigDecimal().movePointLeft(swap.toToken.decimals)
            .stripTrailingZeros()
