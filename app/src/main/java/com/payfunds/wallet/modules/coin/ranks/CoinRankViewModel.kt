...
import com.payfunds.wallet.modules.coin.ranks.CoinRankModule.RankAnyValue
import com.payfunds.wallet.modules.coin.ranks.CoinRankModule.UiState
...
class CoinRankViewModel(
    ...
    private suspend fun getRank(rankType: RankType, currencyCode: String) =
