...
import com.payfunds.wallet.core.adapters.zcash.ZcashAddressValidator
import com.payfunds.wallet.entities.Address
import com.payfunds.wallet.entities.BitcoinAddress
...
class AddressHandlerBase58(network: Network, override val blockchainType: BlockchainType) :
    IAddressHandler {
...
class AddressHandlerBech32(network: Network, override val blockchainType: BlockchainType) :
    IAddressHandler {
...
class AddressHandlerBitcoinCash(network: Network, override val blockchainType: BlockchainType) :
    IAddressHandler {
