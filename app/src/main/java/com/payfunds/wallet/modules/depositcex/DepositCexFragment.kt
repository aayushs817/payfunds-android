...
import com.payfunds.wallet.modules.depositcex.ReceiveRoutes.ASSET_SELECT_SCREEN
import com.payfunds.wallet.modules.depositcex.ReceiveRoutes.DEPOSIT_SCREEN
import com.payfunds.wallet.modules.depositcex.ReceiveRoutes.NETWORK_SELECT_SCREEN
import com.payfunds.wallet.modules.depositcex.ReceiveRoutes.USED_ADDRESS_SCREEN
import com.payfunds.wallet.modules.receive.CloseWithMessage
import com.payfunds.wallet.modules.receive.navigateBack
import com.payfunds.wallet.modules.receive.sharedViewModel
            ...
            composablePage(DEPOSIT_SCREEN) { entry ->
                ...
                val addressViewModel =
                    viewModel<DepositAddressViewModel>(
                        factory = DepositAddressViewModel.Factory(
                            cexAsset,
                            viewModel.network
                        )
                    )
