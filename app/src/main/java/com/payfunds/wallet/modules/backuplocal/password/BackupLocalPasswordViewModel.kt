package com.payfunds.wallet.modules.backuplocal.password

import androidx.lifecycle.viewModelScope
import com.payfunds.wallet.R
import com.payfunds.wallet.core.IAccountManager
import com.payfunds.wallet.core.PasswordError
...
class BackupLocalPasswordViewModel(
    ...
    var backupFileName: String = "PF_Backup.json"
        private set
        ...
        when (type) {
            is BackupType.SingleWalletBackup -> {
                ...
                if (account == null) {
                    ...
                    backupFileName = "PF_Backup_${walletName}_${currentDateTime}.json"
                }
            }

            is BackupType.FullBackup -> {
                backupFileName = "PF_App_Backup_${currentDateTime}.json"
            }
        }
