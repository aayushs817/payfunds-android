...
import com.payfunds.wallet.entities.nft.NftAssetMetadata.SaleType
import com.payfunds.wallet.entities.nft.NftAssetMetadata.Trait
...
class NftAssetViewModel(private val service: NftAssetService) : ViewModel() {
    ...
    private fun linkViewItems(
        asset: NftAssetMetadata,
            ...
            sale.bestListing?.let { listing ->
                SaleViewItem(
                    untilDate = TranslatableString.ResString(
                        R.string.Nfts_Asset_OnSaleUntil,
                        DateHelper.getFullDate(listing.untilDate)
                    ),
                    type = sale.type,
