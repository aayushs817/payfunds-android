...
import com.payfunds.wallet.modules.market.etf.EtfModule.EtfViewItem
import com.payfunds.wallet.modules.market.etf.EtfModule.RankedEtf
...
class EtfViewModel(
    ...
    private fun fetchChartData() {
        viewModelScope.launch(Dispatchers.Default) {
            etfPoints =
                marketKit.etfPoints(currencyManager.baseCurrency.code).await().sortedBy { it.date }
