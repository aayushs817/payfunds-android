package com.payfunds.wallet.modules.contacts
...
import com.payfunds.wallet.modules.contacts.model.ContactAddress
import com.payfunds.wallet.modules.contacts.screen.AddressScreen
import com.payfunds.wallet.modules.contacts.screen.BlockchainSelectorScreen
import com.payfunds.wallet.modules.contacts.screen.ContactScreen
import com.payfunds.wallet.modules.contacts.screen.ContactsScreen
import com.payfunds.wallet.modules.contacts.viewmodel.AddressViewModel
import com.payfunds.wallet.modules.contacts.viewmodel.ContactViewModel
import com.payfunds.wallet.modules.contacts.viewmodel.ContactsViewModel
import io.payfunds.core.getNavigationResult
import io.payfunds.core.parcelable
import io.payfunds.core.setNavigationResult
            ...
            ContactScreen(
                ...
                onNavigateToAddress = { address ->
                    navHostController.getNavigationResult("contacts_address_result") { bundle ->
                        ...
                        bundle.parcelable<ContactAddress>("deleted_address")
                            ?.let { deletedAddress ->
