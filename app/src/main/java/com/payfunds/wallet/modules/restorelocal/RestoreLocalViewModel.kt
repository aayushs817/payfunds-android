...
import com.payfunds.wallet.modules.backuplocal.BackupLocalModule.WalletBackup
...
import com.payfunds.wallet.modules.backuplocal.fullbackup.DecryptedFullBackup
import com.payfunds.wallet.modules.backuplocal.fullbackup.FullBackup
import com.payfunds.wallet.modules.backuplocal.fullbackup.RestoreException
...
import com.payfunds.wallet.modules.restorelocal.RestoreLocalModule.UiState
...
class RestoreLocalViewModel(
    ...
    fun createAccount(accountType: AccountType, referralCode: String? = null) {
        ...
        account?.let { mAccount ->
            val address = getWalletAddress(mAccount)
            address?.let {
                viewModelScope.launch(Dispatchers.IO) {
